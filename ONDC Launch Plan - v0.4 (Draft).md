...
| 4    | Key pairs for signing & encryption | Pseudonymous key pairs for signing & encryption, as defined [here](https://docs.google.com/document/d/1-xECuAHxzpfF8FEZw9iN3vT7D3i6yDDB1u2dEApAjPA/edit)| Pseudonymous key pairs for signing & encryption, as defined [here](https://docs.google.com/document/d/1-xECuAHxzpfF8FEZw9iN3vT7D3i6yDDB1u2dEApAjPA/edit) 
...
| 9    | Functional Test - Exception flows  | **Includes Normal flow, returns (part), cancel, grievance;**<br /><br />**Draft proposal for cancellation, return & replacement is** [**here**](https://docs.google.com/document/d/1M-lZSduYMFKIk1V6d8QLt-j-16-rVzYVdPn0pmbkclk/edit)**;**<br /><br />**Detailed flows to be provided;** | **Includes Normal flow, returns (part), cancel, grievance;**<br /><br />**Draft proposal for cancellation, return & replacement is** [**here**](https://docs.google.com/document/d/1M-lZSduYMFKIk1V6d8QLt-j-16-rVzYVdPn0pmbkclk/edit)**;**<br /><br />**Detailed flows to be provided;** |
