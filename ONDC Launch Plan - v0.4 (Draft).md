...
| ---- | ---------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 1    | Protocol version                   | Transaction APIs - use latest version [here](https://github.com/Open-network-for-digital-commerce/ONDC-Protocol-Specs/tree/master/protocol-specifications/core/v0/api);Registry APIs - 0.2.0 | Transaction APIs - current version is 0.9.3 (expect 0.9.4 for soft launch);Registry APIs - 0.2.0 |
